...
in {
  ...
  services.matrix-appservices = {
    addRegistrationFiles = false; # only for synapse and dendrite
    homeserverURL = "https://${matrix_hostname}/";
    ...
    services = {
      signal = {
        ...
        settings = {
          #homeserver.address = "http://${matrix_hostname}";
          #homeserver.domain = server_name;
          bridge.permissions = {
            "@adminuser:${server_name}" = "admin";
            "${server_name}" = "user";
            "*" = "relay";
          };
        };
